...
impl Color {
        ...
        ComponentParser: ColorComponentParser<'i>,
    {
        ...
        match token {
            Token::Hash(ref value) | Token::IDHash(ref value) => Ok(hex(value)),
...
impl ToCss for Color {
    ...
    where
        W: fmt::Write,
    {
        let serialize_alpha = self.alpha >= 0.;
...
where
    ComponentParser: ColorComponentParser<'i>,
{
    let (red, green, blue, uses_commas) = match name.to_lowercase().as_str() {
