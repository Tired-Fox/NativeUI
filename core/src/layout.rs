...
use style::{Dimensions, Position, Size, Unit};

use crate::Rect;

use super::prelude::{Component, Container};
...
impl<Data, Error> Layout<Data, Error> {
    ...
    fn calc(
        ...
        // PERF: Simplify and split up layout calculations
